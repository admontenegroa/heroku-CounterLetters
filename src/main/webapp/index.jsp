			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<div class="tm-wrapper-center">
					...
					<form action="/CounterLetters/login" method="post">
						<label for="password">Si desea conocer el número de letras
							que contiene una palabra. Primero debe iniciar sesión</label> <input
							type="password" id="usuario" name="usuario" class="form-control" />
						<input type="submit" name="submit" value="Iniciar Sesion"
							onclick="sesionIniciada()" />
						<script>
